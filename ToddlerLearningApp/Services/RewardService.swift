...
final class RewardService {
    ...
    func trophies(for child: ChildProfile) -> [Trophy] {
        ...
        return [
            ...
            Trophy(id: "five-traced", title: "Pencil Pal", emoji: "✏️",
                   detail: "Master tracing 5 letters",
                   isUnlocked: child.masteredTraceCount >= 5),
            Trophy(id: "all-traced", title: "Handwriting Hero", emoji: "📝",
                   detail: "Master tracing every letter",
                   isUnlocked: total > 0 && child.masteredTraceCount >= total),
